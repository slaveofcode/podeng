...
//   const Obj1 = blueprint.object({
//     num: types.integer({ serialize: { to: 'number1' } }),
//     num2: types.integer({ min: 5, deserialize: { from: 'number2' } }),
//     num3: types.integer
//   });
...
//     num2: ['Minimum value of "num2" is 5']
//   });

//   expect(err2).toBe(true);
//   expect(errDetails2).toEqual({
//     number2: ['Minimum value of "number2" is 5']
//   });
// });
